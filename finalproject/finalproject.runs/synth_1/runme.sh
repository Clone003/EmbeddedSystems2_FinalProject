...
HD_PWD='C:/Users/johnr/Projects/EmbeddedSystems2_FinalProject/finalproject/finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalproject_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalproject_design_wrapper.tcl
