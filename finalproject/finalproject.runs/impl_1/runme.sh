...
HD_PWD='C:/Users/johnr/Projects/EmbeddedSystems2_FinalProject/finalproject/finalproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log finalproject_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source finalproject_design_wrapper.tcl -notrace
