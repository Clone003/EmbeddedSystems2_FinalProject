...
--Command     : generate_target gps_design_wrapper.bd
--Design      : gps_design_wrapper
...
end gps_design_wrapper;

architecture STRUCTURE of gps_design_wrapper is
  component gps_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
gps_design_i: component gps_design
     port map (
