...
HD_PWD='C:/Users/johnr/Projects/EmbeddedSystems2_FinalProject/singlePmods/gps/gps.runs/gps_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gps_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gps_design_xbar_0.tcl
