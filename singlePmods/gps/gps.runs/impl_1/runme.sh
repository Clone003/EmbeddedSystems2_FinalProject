...
HD_PWD='C:/Users/johnr/Projects/EmbeddedSystems2_FinalProject/singlePmods/gps/gps.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gps_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gps_design_wrapper.tcl -notrace
